...
Module['FS_createPath']('/packages/gk/fantasy', 'skyfantasyJPG', true, true);
    ...
    filePreload3.open('GET', 'packages/gk/fantasy/rock_formation_gk_v01/package.cfg', true);
    ...
    filePreload4.open('GET', 'packages/gk/fantasy/wooden_roof_tiles_gk_v01/package.cfg', true);
    ...
    filePreload5.open('GET', 'packages/gk/fantasy/iron_trim_gk_v01/package.cfg', true);
    ...
    filePreload6.open('GET', 'packages/gk/fantasy/stone_ground_tiles_gk_v01/package.cfg', true);
    ...
    filePreload7.open('GET', 'packages/gk/fantasy/castell_wall_gk_v03/package.cfg', true);
    ...
    filePreload8.open('GET', 'packages/gk/fantasy/package.cfg', true);
    ...
    filePreload9.open('GET', 'packages/gk/fantasy/stone_ground_gk_v01/package.cfg', true);
    ...
    filePreload10.open('GET', 'packages/gk/fantasy/rock_formation_gk_v02/package.cfg', true);
    ...
    filePreload12.open('GET', 'packages/gk/fantasy/castell_wall_gk_v01/package.cfg', true);
    ...
    filePreload15.open('GET', 'packages/gk/fantasy/castell_wall_gk_v02/package.cfg', true);
    ...
    filePreload16.open('GET', 'packages/gk/fantasy/iron_intersection_gk_v01/package.cfg', true);
    ...
    filePreload17.open('GET', 'packages/gk/fantasy/castell_wall_trim_gk_v01/package.cfg', true);
    ...
    filePreload42.open('GET', 'packages/gk/fantasy/skyfantasyJPG/skyfantasy_dn.jpg', true);
    ...
    filePreload44.open('GET', 'packages/gk/fantasy/skyfantasyJPG/skyfantasy_up.jpg', true);
    ...
    filePreload45.open('GET', 'packages/gk/fantasy/skyfantasyJPG/skyfantasy_bk.jpg', true);
